...
import { ArrowRight, CalendarDays, CarFront, CheckCircle2, Headphones, KeyRound, ShieldCheck, Smartphone, Tag, Bike } from "lucide-react";

const vehicles = [
  { name: "Alto CNG", type: "CAR", meta: "4 Seats · CNG · Manual", price: "₹1,800", image: "/assets/alto.png" },
  { name: "Activa 6G", type: "BIKE", meta: "2 Seats · Petrol · Automatic", price: "₹199", image: "/assets/activa.png" },
  { name: "WagonR CNG", type: "CAR", meta: "5 Seats · CNG · Manual", price: "₹2,000", image: "/assets/wagonr.png" },
  { name: "Dzire CNG", type: "CAR", meta: "4 Seats · CNG · Manual", price: "₹2,200", image: "/assets/dzire.png" },
];
...
export default function Home() {
  return <main>
    ...
    <section className="hero" id="home"><div className="hero-glow"/><div className="container hero-grid"><motion.div initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:.7}}><div className="eyebrow"><i/> BHOPAL'S SELF-DRIVE MOBILITY</div><h1>Freedom on<br/><span>Your Terms!</span></h1><h2>Rent a Car. Ride a Bike. Move Freely.</h2><p>Self-drive cars & self-ride bikes on rent in Bhopal — affordable prices, simple booking and trusted service.</p><div className="hero-features"><Feature icon={CarFront} text="Self-Drive Freedom"/><Feature icon={Tag} text="Affordable Prices"/><Feature icon={ShieldCheck} text="Verified & Safe"/><Feature icon={Headphones} text="24×7 Support"/></div></motion.div><motion.div className="hero-visual" initial={{opacity:0,scale:.96}} animate={{opacity:1,scale:1}} transition={{duration:.8,delay:.15}}><div className="hero-vehicle"><img src="/assets/hero-vehicle.png" alt="Allino rental car and scooter"/></div><div className="hero-app"><Smartphone size={28}/><b>ALLINO APP</b><span>Book. Ride. Relax.</span><strong>Download Now →</strong></div></motion.div></div>
      <div className="container booking" id="book"><div className="section-kicker">BOOK YOUR RIDE</div><h3>Where do you want to go?</h3><div className="tabs"><button className="active">🚗 Self-Drive Car</button><button>🛵 Self-Ride Bike</button></div><div className="booking-grid"><label>Pickup Location<input value="Bhopal, Madhya Pradesh" readOnly/></label><label>Pickup Date<input type="date"/></label><label>Pickup Time<input type="time" defaultValue="10:00"/></label><label>Return Date<input type="date"/></label><label>Return Time<input type="time" defaultValue="10:00"/></label><a className="btn primary search" href="#fleet">Search Vehicles <ArrowRight size={18}/></a></div></div>
    </section>
    ...
    <section className="pricing section" id="pricing"><div className="container"><div className="center"><div className="section-kicker">SIMPLE PRICING</div><h2>Pay for the time you need.</h2><p>Short trips, weekends and longer stays.</p></div><div className="plans">{[["1 DAY","₹1,800","Base rental rate"],["3 DAYS","₹5,100","Better weekend rate"],["7 DAYS","₹10,500","Great for road trips"]].map((p,i)=><article className={i===1?"popular":""} key={p[0]}>{i===1&&<label>POPULAR</label>}<span>{p[0]}</span><strong>{p[1]}<small> / period</small></strong><ul><li>✓ KYC verification</li><li>✓ Support included</li><li>✓ Transparent pricing</li></ul><a className={`btn ${i===1?"primary":"outline"}`} href="#book">Book Now</a></article>)}</div></div></section>

    <section className="about section" id="about-us"><div className="container about-grid"><div className="about-photo"><img src="/assets/bhopal-landmark.jpg" alt="Bhopal landmark"/></div><div><div className="section-kicker">ABOUT ALLINO</div><h2>Your trusted mobility partner in Bhopal.</h2><p>Allino gives customers a simple way to rent clean, verified cars and scooters without the cost of ownership.</p><div className="checks"><span>✓ Customer-first approach</span><span>✓ Transparent pricing</span><span>✓ Well-maintained fleet</span><span>✓ Responsive support</span></div><a className="btn primary" href="#contact">About Allino <ArrowRight size={18}/></a></div></div></section>

    <section className="contact section" id="contact"><div className="container contact-box"><div><div className="section-kicker light">READY TO RIDE?</div><h2>Freedom on your terms.</h2><p>Book your next ride or talk to our team.</p></div><div><a className="btn yellow" href="tel:+919893345906">Call +91 98933 45906</a><a className="btn light" href="#book">Book a Ride →</a></div></div></section>
